...
class EngineDataProcessor:
    ...
    def segregate_and_zip(self, df):
        zip_filename = "C:\\Users\\ssen\\Documents\\RUL\\RULprediction\\processed_data_all_1.zip"
        with ZipFile(zip_filename, 'w') as zipf:
            for unit_number in df['unit_number'].unique():
                csv_filename = f"unit_{unit_number}_5_processed.csv"
...
# Example usage
processor = EngineDataProcessor(file_path='C:\\Users\\ssen\\Documents\\FlexKI\\EngineHealthPred\\ChallengeData\\train.txt')
zip_file = processor.process_data()